...
//     (0.S,2.S,2.S,0.S) -> "b000".U,
//     (1.S,1.S,2.S,2.S) -> "b010".U,
//     (2.S,1.S,1.S,2.S) -> "b100".U,
//     (2.S,1.S,2.S,1.S) -> "b110".U,
//     (-2.S,2.S,2.S,-2.S) -> "b000".U,
//     (-1.S,-1.S,2.S,2.S) -> "b010".U,
//     (2.S,-1.S,-1.S,2.S) -> "b100".U,
//     (2.S,-1.S,2.S,-1.S) -> "b110".U,
//     (2.S,0.S,0.S,2.S) -> "b000".U,
//     (2.S,2.S,1.S,1.S) -> "b010".U,
//     (1.S,2.S,2.S,1.S) -> "b100".U,
//     (1.S,2.S,1.S,2.S) -> "b110".U,
//     (2.S,-2.S,-2.S,2.S) -> "b000".U,
//     (2.S,2.S,-1.S,-1.S) -> "b010".U,
//     (-1.S,2.S,2.S,-1.S) -> "b100".U,
//     (-1.S,2.S,-1.S,2.S) -> "b110".U,
//     (2.S,2.S,2.S,2.S) -> "b000".U,
//     (2.S,2.S,2.S,2.S) -> "b010".U,
//     (2.S,2.S,2.S,2.S) -> "b100".U,
//     (2.S,2.S,2.S,2.S) -> "b110".U,
//     (2.S,2.S,2.S,-2.S) -> "b000".U,
//     (2.S,2.S,2.S,-2.S) -> "b010".U,
//     (2.S,2.S,2.S,-2.S) -> "b100".U,
//     (2.S,2.S,2.S,-2.S) -> "b110".U,
...
//     (-2.S,2.S,2.S,2.S) -> "b100".U,
//     (-2.S,2.S,2.S,2.S) -> "b110".U,
//     (2.S,2.S,0.S,1.S) -> "b001".U,
//     (0.S,2.S,1.S,2.S) -> "b011".U,
//     (1.S,2.S,2.S,0.S) -> "b101".U,
//     (2.S,1.S,2.S,0.S) -> "b111".U,
//     (2.S,2.S,-2.S,-1.S) -> "b001".U,
//     (-2.S,2.S,-1.S,2.S) -> "b011".U,
//     (-1.S,2.S,2.S,-2.S) -> "b101".U,
//     (2.S,-1.S,2.S,-2.S) -> "b111".U,
//     (2.S,0.S,2.S,1.S) -> "b001".U,
//     (2.S,0.S,1.S,2.S) -> "b011".U,
//     (1.S,0.S,2.S,2.S) -> "b101".U,
//     (2.S,1.S,0.S,2.S) -> "b111".U,
//     (2.S,-2.S,2.S,-1.S) -> "b001".U,
//     (2.S,-2.S,-1.S,2.S) -> "b011".U,
//     (-1.S,-2.S,2.S,2.S) -> "b101".U,
//     (2.S,-1.S,-2.S,2.S) -> "b111".U
...
//   for (((tValues), sdn6_8) <- reverseLookup_xxxxxx) {
