...
module FFE(	// @[generators/chipyard/src/main/scala/FFE.scala:110:9]
  ...
  always @(posedge clock) begin	// @[generators/chipyard/src/main/scala/FFE.scala:110:9]
    if (reset) begin	// @[generators/chipyard/src/main/scala/FFE.scala:110:9]
      weightRegs_0 <= 8'd0;	// @[generators/chipyard/src/main/scala/FFE.scala:118:57]
      weightRegs_1 <= 8'd127;	// @[generators/chipyard/src/main/scala/FFE.scala:118:57]
      weightRegs_2 <= 8'hD6;	// @[generators/chipyard/src/main/scala/FFE.scala:118:57]
      weightRegs_3 <= 8'd14;	// @[generators/chipyard/src/main/scala/FFE.scala:118:57]
      weightRegs_4 <= 8'hFC;	// @[generators/chipyard/src/main/scala/FFE.scala:118:57]
      weightRegs_5 <= 8'd1;	// @[generators/chipyard/src/main/scala/FFE.scala:118:57]
      weightRegs_6 <= 8'd0;	// @[generators/chipyard/src/main/scala/FFE.scala:118:57]
    end
